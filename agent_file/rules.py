...
def get_installed_applications():
    ...
    # Method 1: Using Scan .desktop files
    try:
    ...
    # Method 2: Using 'dpkg' for Debian-based systems
    try:
    ...
    # Method 3: Using 'rpm' for Red Hat-based systems
    try:
    ...
    # Method 4: Using Scan /usr/bin and /usr/local/bin
    ...
    # Method 5: Listing the system services
    try:
